...
class CirclePulsing: CAShapeLayer {
    ...
    init(position: CGPoint, toRadius: CGFloat, color: CGColor) {
        ...
        self.fillColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
        ...
        DispatchQueue.global(qos: DispatchQoS.QoSClass.default).async {
            ...
            DispatchQueue.main.async {
                self.add(self.animationGroup, forKey: "CirclePulsing")
            }
        }
    }
    ...
    func createPathAnimation() -> CABasicAnimation {
        ...
        let toPath = UIBezierPath(arcCenter: self.pathPosition
            , radius: self.toRadius, startAngle: 0, endAngle: CGFloat.pi * 2, clockwise: true)
